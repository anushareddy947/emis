...
def insert_data(json_data):
  ...
  #mycursor.execute("CREATE DATABASE IF NOT EXISTS json_data")
   ...
   # mycursor.execute("CREATE TABLE login (CREATE TABLE patient_data (id INT(11) AUTO_INCREMENT PRIMARY KEY,family_name VARCHAR(200), First_name VARCHAR(200))")
    sql = "INSERT INTO patient_data (resource_type, entry_resource_type,family_name,First_name,phone_number,city,address,gender,Language,postalcode) VALUES (%s, %s, %s,%s,%s,%s,%s,%s,%s,%s)"
  #sql = "INSERT INTO login (family_name, First_name) VALUES(%s, %s)"
